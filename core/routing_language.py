...
class RoutingLanguageNormalizer:
    ...
    _PHRASE_REPLACEMENTS = (
        ...
        ("puedes verificar si", "can you verify whether"),
        ("puedes verificar que", "can you verify that"),
        ("podrias verificar si", "could you verify whether"),
        ("verifica si", "verify whether"),
        ("verifica que", "verify that"),
        ("puedes confirmar si", "can you confirm whether"),
        ("puedes confirmar que", "can you confirm that"),
        ("podrias confirmar si", "could you confirm whether"),
        ("confirma si", "confirm whether"),
        ("confirma que", "confirm that"),
        ("comprueba si", "verify whether"),
        ("es verdad que", "is it true that"),
        ("estas seguro", "are you sure"),
        ("estas segura", "are you sure"),
        ("que tan seguro estas", "how sure are you"),
        ("que tan segura estas", "how sure are you"),
        ("es eso correcto", "is that correct"),
        ("es esto correcto", "is this correct"),
        ("es eso exacto", "is that accurate"),
        ("es esto exacto", "is this accurate"),
